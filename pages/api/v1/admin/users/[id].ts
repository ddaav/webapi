...
import { withAdminAuth, AuthenticatedRequest } from '../../../../../lib/api/authMiddleware';
...
async function handler(
  ...
  if (req.method === 'GET') {
    try {
      ...
      return res.status(500).json({ success: false, message: 'Internal server error while fetching user' });
    }
  }
